            	...
            	if($_POST["table"]=="Units") {
						...
						$unit_count = 0;
						 while($data = fgetcsv($work_file, 1000, ",")) {
							$new_units[$unit_count]["Name"] = $data[0];
							$new_units[$unit_count]["GradeLevel_id"] = $data[1];
							$new_units[$unit_count]["Subject_id"] = $data[2];
							$new_units[$unit_count]["StartDate"] = $data[3];
							$new_units[$unit_count]["EndDate"] = $data[4];
							$unit_count++;
						}
