...
<section id="content">
    ...
    <form id="admin-edit" method="post" action="admin-users.php">
        <hr>
        <input size="30" id="username" type="text" name="username"></input>
        <label for="username">Admin Username</label><br>
        <input size="30" id="password" type="password" name="password"></input>
        <label for="password">Password</label><br>
        <input id="is-admin" name="is-admin" type="checkbox"></input>
        <label for="is-admin">User is Administrator</label><br>
        <input class="button" id="submit" type="submit" name="submit" value="New User"></input>
